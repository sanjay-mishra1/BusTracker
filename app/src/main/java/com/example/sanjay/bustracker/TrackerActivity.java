...
public class TrackerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRouteEditText = (EditText) findViewById(R.id.Route_id);
        ...
        String route = mPrefs.getString(getString(R.string.route), "");

        mTransportIdEditText.setText(transportID);
        mEmailEditText.setText(email);
        mPasswordEditText.setText(password);
        mRouteEditText.setText(route);
        if (isServiceRunning(TrackerService.class)) {
           ...
           // mEmailEditText.setText("build_email");
            //mPasswordEditText.setText("build_password");
        }
    ...
    private void checkInputFields() {
        if (mTransportIdEditText.length() == 0 || mEmailEditText.length() == 0 ||
            ...
            editor.putString(getString(R.string.route), mRouteEditText.getText().toString());
            editor.apply();
